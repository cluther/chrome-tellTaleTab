function getSiteConfigs() { return [
{ // Google Reader
    "matches": [
...
{ // SugarCRM
    ...
    "poll": {
        ...
        "doit": function() {
            ...
            if (user_id) {
                var xhr = new XMLHttpRequest();
                xhr.open("GET", "https://crm.zenoss.com/index.php?module=Cases&query=true&searchFormTab=advanced_search&assigned_user_id_advanced=" + user_id + "&status_advanced%5B%5D=New&status_advanced%5B%5D=Assigned%20-%20In%20Progress&status_advanced%5B%5D=Re-Opened", true);
                xhr.send();
                xhr.onreadystatechange = function() {
                    if (xhr.readyState == 4) {
    ...
    "icon": [
        ['', '', '', '', '', '#686868', '#686868', '#686868', '#686868', '#686868', '', '', '', '', '', ''],
        ['', '', '', '#686868', '#686868', '#aeccfc', '#aeccfc', '#aeccfc', '#aeccfc', '#aeccfc', '#686868', '#686868', '#686868', '', '', ''],
        ['', '#686868', '#686868', '#aeccfc', '#aeccfc', '#aeccfc', '#aeccfc', '#aeccfc', '#aeccfc', '#aeccfc', '#aeccfc', '#aeccfc', '#aeccfc', '#686868', '#686868', ''],
        ['#686868', '#e91712', '#aeccfc', '#aeccfc', '#aeccfc', '#aeccfc', '#aeccfc', '#aeccfc', '#aeccfc', '#aeccfc', '#aeccfc', '#aeccfc', '#aeccfc', '#aeccfc', '#0a50dd', '#686868'],
        ['#686868', '#e91712', '#e91712', '#e91712', '#e91712', '#aeccfc', '#aeccfc', '#aeccfc', '#aeccfc', '#aeccfc', '#aeccfc', '#0a50dd', '#0a50dd', '#0a50dd', '#0a50dd', '#686868'],
        ['#686868', '#e91712', '#e91712', '#e91712', '#e91712', '#e91712', '#e91712', '#aeccfc', '#aeccfc', '#0a50dd', '#0a50dd', '#0a50dd', '#0a50dd', '#0a50dd', '#0a50dd', '#686868'],
        ['#686868', '#e91712', '#e91712', '#e91712', '#e91712', '#e91712', '#e91712', '#e91712', '#0a50dd', '#0a50dd', '#0a50dd', '#0a50dd', '#0a50dd', '#0a50dd', '#0a50dd', '#686868'],
        ['#686868', '#e91712', '#e91712', '#e91712', '#e91712', '#e91712', '#e91712', '#e91712', '#0a50dd', '#0a50dd', '#0a50dd', '#0a50dd', '#0a50dd', '#0a50dd', '#0a50dd', '#686868'],
        ['#686868', '#e91712', '#e91712', '#e91712', '#e91712', '#e91712', '#e91712', '#e91712', '#0a50dd', '#0a50dd', '#0a50dd', '#0a50dd', '#0a50dd', '#0a50dd', '#0a50dd', '#686868'],
        ['#686868', '#e91712', '#e91712', '#e91712', '#e91712', '#e91712', '#e91712', '#e91712', '#0a50dd', '#0a50dd', '#0a50dd', '#0a50dd', '#0a50dd', '#0a50dd', '#0a50dd', '#686868'],
        ['#686868', '#e91712', '#e91712', '#e91712', '#e91712', '#e91712', '#e91712', '#e91712', '#0a50dd', '#0a50dd', '#0a50dd', '#0a50dd', '#0a50dd', '#0a50dd', '#0a50dd', '#686868'],
        ['#686868', '#e91712', '#e91712', '#e91712', '#e91712', '#e91712', '#e91712', '#e91712', '#0a50dd', '#0a50dd', '#0a50dd', '#0a50dd', '#0a50dd', '#0a50dd', '#0a50dd', '#686868'],
        ['#686868', '#e91712', '#e91712', '#e91712', '#e91712', '#e91712', '#e91712', '#e91712', '#0a50dd', '#0a50dd', '#0a50dd', '#0a50dd', '#0a50dd', '#0a50dd', '#0a50dd', '#686868'],
        ['#686868', '#686868', '#e91712', '#e91712', '#e91712', '#e91712', '#e91712', '#e91712', '#0a50dd', '#0a50dd', '#0a50dd', '#0a50dd', '#0a50dd', '#0a50dd', '#686868', '#686868'],
        ['', '', '#686868', '#686868', '#686868', '#e91712', '#e91712', '#e91712', '#0a50dd', '#0a50dd', '#0a50dd', '#686868', '#686868', '#686868', '', ''],
        ['', '', '', '', '', '#686868', '#686868', '#686868', '#686868', '#686868', '#686868', '', '', '', '', '']
    ]
}
]}

function matchSite() {
    var site_configs = getSiteConfigs();
...
chrome.extension.sendRequest('getPreferences', function(response) {
